		...
		<div className="TermsConditions">
			...
			<PageSection title="Welcome To InThisOrder!">
				...
				<p>
					...
					and conditions. Do not continue to use InThisOrder if you do
					not agree to take all of the terms and conditions stated on
					this page. Our Terms and Conditions were created with the
					help of the Terms And Conditions Generator and the Free
				...
				<h4>Cookies</h4>
				<p>
					We employ the use of cookies. By accessing InThisOrder, you
					agreed to use cookies in agreement with the The Kirk
					Concept’s Privacy Policy.
				</p>
				...
				<h4>License</h4>
				<p>
					Unless otherwise stated, The Kirk Concept and/or its
					licensors own the intellectual property rights for all
					material on InThisOrder. All intellectual property rights
					are reserved. You may access this from InThisOrder for your
				...
				<ul>
					<li>Republish material from InThisOrder</li>
					<li>Sell, rent or sub-license material from InThisOrder</li>
					<li>
						Reproduce, duplicate or copy material from InThisOrder
					</li>
					<li>Redistribute content from InThisOrder</li>
				...
				<p>
					...
					the website. The Kirk Concept does not filter, edit, publish
					or review Comments prior to their presence on the website.
					Comments do not reflect the views and opinions of The Kirk
					Concept,its agents and/or affiliates. Comments reflect the
					views and opinions of the person who post their views and
					opinions. To the extent permitted by applicable laws, The
					Kirk Concept shall not be liable for the Comments or for any
				...
				<p>
					The Kirk Concept reserves the right to monitor all Comments
				...
				<ul>
					...
					<li>
						You hereby grant The Kirk Concept a non-exclusive
				...
				<p>
					...
					compensates the absence of The Kirk Concept; and (d) the
				...
				<p>
					...
					inform us by sending an e-mail to The Kirk Concept. Please
				...
				<ul>
					...
					<li>
						No use of The Kirk Concept’s logo or other artwork will
