    ...
    <div className="TermsConditionsPage">
      ...
      <PageSection title="Welcome To InThisOrder!">
        <p>
          ...
          use of The Kirk Concept’s Website, located at inthisorder.app.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use InThisOrder if you do not agree to
        ...
        <h4>Cookies</h4>
        <p>
          We employ the use of cookies. By accessing InThisOrder, you agreed to
          use cookies in agreement with the The Kirk Concept’s Privacy Policy.
        </p>
        ...
        <h4>License</h4>
        <p>
          Unless otherwise stated, The Kirk Concept and/or its licensors own the
          intellectual property rights for all material on InThisOrder. All
          intellectual property rights are reserved. You may access this from
          InThisOrder for your own personal use subjected to restrictions set in
        ...
        <ul>
          ...
          <li>Reproduce, duplicate or copy material from InThisOrder</li>
        ...
        <p>
          ...
          Kirk Concept does not filter, edit, publish or review Comments prior
          to their presence on the website. Comments do not reflect the views
          and opinions of The Kirk Concept,its agents and/or affiliates.
        ...
        <p>
          The Kirk Concept reserves the right to monitor all Comments and to
        ...
        <ul>
          ...
          <li>
            You hereby grant The Kirk Concept a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of The Kirk Concept; and (d) the
        ...
        <p>
          ...
          sending an e-mail to The Kirk Concept. Please include your name, your
        ...
        <ul>
          ...
          <li>
            No use of The Kirk Concept’s logo or other artwork will be allowed
