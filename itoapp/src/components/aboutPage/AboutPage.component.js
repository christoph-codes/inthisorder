        ...
        <div className="uk-grid uk-grid-large">
          ...
          <div className="uk-width-3-5@m">
            ...
            <p>
              ...
              married for 8 going on 87 years with two beautiful kids.<br/><br/>What
              prompted me to create InThisOrder was my need to organize tasks for my
              ...
              here.<br/><br/>In the meantime, shoot me an email with any questions at{' '}
              <a href="mailto:tkcwebdev@gmail.com">tkcwebdev@gmail.com</a> or
              connect with me on LinkedIn.<br/><br/><strong>Enjoy InThisOrder!</strong>
            </p>
          </div>
        </div>
      </PageSection>
